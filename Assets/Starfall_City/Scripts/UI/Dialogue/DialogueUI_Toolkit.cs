...
namespace DialogueSystem
{
    public class DialogueUI_Toolkit : MonoBehaviour
    {
        ...
        private VisualElement GetRoot() => _uiDocument.rootVisualElement.Q<VisualElement>("Root");
        private VisualElement GetPanel() => _uiDocument.rootVisualElement.Q<VisualElement>("DialoguePanel");
        ...
        {
            _history.Add(new HistoryEntry(speaker, text, isNarrative, isPlayer));
