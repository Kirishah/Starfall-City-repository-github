...
namespace QuestSystem
{
    public class QuestManager : MonoBehaviour
    {
        ...
        private HashSet<QuestSO> _activeQuestSet = new();
        private Queue<Quest> _questPoolQueue = new();
        private Dictionary<string, (int current, int required)> _objectiveProgress = new(); // Tracks progress by ObjectiveID
        ...
        // Call this in Awake or after loading a save
        ...
        public bool IsQuestActive(QuestSO questSO) => _activeQuestSet.Contains(questSO);
        ...
        public void StartQuest(QuestSO questSO)
        {
            ...
            var quest = _questPoolQueue.Dequeue();
        ...
        {
            Debug.Log($"QuestManager: Attempting to complete quest {quest.Data.Title}");
            if (quest == null)
            {
        ...
        public Quest FindQuestByObjective(ObjectiveSO objective) => _activeQuests.Find(quest => quest.Data.Objectives.Contains(objective));
            ...
            foreach (var followUp in completedQuest.FollowUpQuests)
            {
                    ...
                    !QuestMemory.Instance.IsQuestCompleted(followUp.Quest))
                {
                    ...
                    if (!string.IsNullOrEmpty(followUp.DialogueStartID))
                    {
                        ...
                        var npcID = followUp.Quest.StartingDialogueID != null ? "default_npc" : ""; // Placeholder; customize as needed
