...
namespace CharacteristicsSystem
{
    public class CharacteristicsManager : MonoBehaviour
    {
        ...
        [SerializeField] private List<Characteristics> _characteristics = new();
        ...
        {
            new() { Type = CharacteristicType.Health, CurrentValue = 0, MinValue = -5, MaxValue = 5, DisplayName = "Health" },
            new() { Type = CharacteristicType.Reputation, CurrentValue = 0, MinValue = -5, MaxValue = 5, DisplayName = "Reputation" },
            new() { Type = CharacteristicType.Blockhead, CurrentValue = 0, MinValue = -5, MaxValue = 5, DisplayName = "Blockhead" },
            new() { Type = CharacteristicType.Aura, CurrentValue = 0, MinValue = -5, MaxValue = 5, DisplayName = "Aura" }
        };
            }
        ...
        {
            var charac = GetCharacteristic(type);
            if (charac != null)
            {
        ...
        public Characteristics GetCharacteristic(CharacteristicType type) => _characteristics.Find(c => c.Type == type);
        #endregion
        ...
        {
            var data = new CharacteristicsSaveData { Characteristics = _characteristics };
        ...
        public void LoadCharacteristics()
        {
            ...
            {
                var json = PlayerPrefs.GetString("CharacteristicsData");
                var data = JsonUtility.FromJson<CharacteristicsSaveData>(json);
